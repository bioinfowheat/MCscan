## Introduction
The ordering and orientation of genomic scaffolds to reconstruct chromosomes is an essential step during *de novo* genome assembly. This process is often assisted by various mapping techniques, including genetic mapping, physical mapping, cytological mapping and exploitation of cross-species synteny. Because each map provides a unique line of evidence, a combination of multiple maps can greatly improve the accuracy of the resulting chromosomal assemblies. In the past, scaffold ordering based on several maps has largely employed *ad hoc* rules to resolve discrepancies and often lacked consistencies across different genome projects. ALLMAPS is capable of computing a scaffold ordering that maximizes the colinearity to a collection of maps. In addition to handling multiple genetic maps, ALLMAPS is also capable of integrating other types of maps, including physical or comparative maps into the final chromosome build. To accommodate differing reliability in mapping techniques, ALLMAPS allows the user to adjust the ranking of evidence by assigning different weights to each input map. ALLMAPS can significantly reduce the assembly time for genome projects and is proven to be a useful tool in building high-quality chromosome-level assemblies. 
